...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        img[model_kwargs['syn_src_key_padding_mask'] == 1] = data.transpose(-1, -2)[model_kwargs['syn_src_key_padding_mask'] == 1]
        img = img.transpose(-1, -2)
        ...
        for i in indices:
            ...
            with th.no_grad():
                ...
                out["sample"].transpose(-1, -2)[model_kwargs['syn_src_key_padding_mask'] == 1] = data.transpose(-1, -2)[model_kwargs['syn_src_key_padding_mask'] == 1]
                yield out
                img = out["sample"]
    ...
    def training_losses(self, model, x_start, t, model_kwargs, analog_bit, noise=None):
        ...
        x_t.transpose(-1, -2)[tmp_mask == 0] = x_start.transpose(-1, -2)[tmp_mask == 0]
